          ...
          <ul class="flex items-center gap-6 text-sm">
            ...
            <li class="hover:-translate-y-2">
              <a
                ...
                href="../ecommerce/html/sobre.html"
              >
                Sobre
              </a>
            </li>
            ...
            <li class="hover:-translate-y-2">
              <a
                ...
                href="../ecommerce/html/produtos.html"
              >
                Produtos
              </a>
            </li>
            ...
            <li class="hover:-translate-y-2">
              <a
                ...
                href="../ecommerce/html/suporte.html"
              >
                Suporte
              </a>
            </li>
...
<div class="z-40 fixed hidden max-md:block w-full bottom-0 bg-white/95 outline outline-1 outline-gray-300 rounded-md shadow-md">
    ...
    <ul class="flex justify-around -mb-px text-sm font-medium text-center text-gray-500 ">
        ...
        <li class="mr-2">
            ...
            <a href="../ecommerce/index.html" class="flex flex-col gap-2 items-center justify-center p-4 text-${telainicio}-600  rounded-t-lg active hover:text-teal-600/60 group" aria-current="page">
        ...
        <li class="mr-2">
            ...
            <a href="../ecommerce/html/sobre.html" class="flex flex-col gap-2 items-center justify-center p-4 text-${telasobre}-600 rounded-t-lg hover:text-teal-600/60  group">
        ...
        <li class="mr-2">
            ...
            <a href="../ecommerce/html/produtos.html" class="flex flex-col gap-2 items-center justify-center p-4 text-${telaprodutos}-600 rounded-t-lg hover:text-teal-600/60 group">
        ...
        <li class="mr-2">
            ...
            <a href="../ecommerce/html/suporte.html" class="flex flex-col gap-2 items-center justify-center text-${telasuporte}-600 p-4  rounded-t-lg hover:text-teal-600/60 group">
