...
class rating02 extends HTMLElement {
  ...
  <div id="classificaoProduto" class=" flex items-center justify-center mb-6 w-full">
     ...
     <p id="txtclassificaoProduto" class="ml-2 text-4xl font-medium text-teal-600 mr-2">${numeroEstrelas}</p>
...
class rating04 extends HTMLElement {
  ...
  <div id="estrelasFormAvaliacao" class="flex items-center space-x-1 cursor-pointer">
