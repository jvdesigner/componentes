  ...
  // ================================================================================== //
      ...
      class cards06 extends HTMLElement {
        constructor() {
          ...
          const pesoProduto = this.getAttribute('pesoProduto') || parseFloat(localStorage.getItem('localPesoProduto'));
    ...
    <!-- Codigo -->
         ...
         btnaumentar.addEventListener('click',()=>{ this.alterarQuantidade('aumentar') })
         btndiminuir.addEventListener('click',()=>{ this.alterarQuantidade('diminuir') })
        ...
        alterarQuantidade(tipo) {
          const inputQuantity = document.getElementById('inputqnt');
