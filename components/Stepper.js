...
<ol id="compStepper" class="flex items-center w-full sm:max-w-2xl">
  ...
  <li class="flex w-full items-center text-teal-600  after:content-[''] after:w-full after:h-1 after:border-b after:border-white after:border-4 after:inline-block cursor-pointer ">
      ...
      <div class="flex items-center justify-center w-20 h-10 bg-teal-500 rounded-full lg:h-12 lg:w-16 shadow hover:scale-[1.2] hover:shadow relative group/informacoes">
  ...
  <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-white after:border-4 after:inline-block cursor-pointer">
      ...
      <div class="flex items-center justify-center w-10 h-10 bg-white rounded-full lg:h-12 lg:w-12  shrink-0 hover:scale-[1.2] hover:shadow relative group/endereco">
  ...
  <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-white after:border-4 after:inline-block cursor-pointer relative group/resumo">
      ...
      <div class="flex items-center justify-center w-10 h-10 bg-white rounded-full lg:h-12 lg:w-12  shrink-0 hover:scale-[1.2] hover:shadow">
  ...
  <li class="flex items-center cursor-pointer ">
      ...
      <div class="flex items-center justify-center w-10 h-10 bg-white rounded-full lg:h-12 lg:w-12 shrink-0 hover:scale-[1.2] hover:shadow relative group/pagamento">
